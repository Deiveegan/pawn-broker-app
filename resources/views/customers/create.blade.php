        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="md-card elevation-2">
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
                    ...
                    <p class="text-blue-100 text-sm mt-1">Register a new customer in the system</p>
                </div>
                ...
                <div class="p-8">
                    <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <label class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-blue-50/50 hover:border-blue-400 transition-all group">
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        <span class="material-icons text-gray-400 group-hover:text-blue-500 text-4xl mb-3 transition-colors">cloud_upload</span>
