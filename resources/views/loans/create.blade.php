        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-xs font-medium text-slate-500 uppercase tracking-widest leading-none mt-1">Add a new loan entry</p>
                </div>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white premium-shadow rounded-[2.5rem] border border-slate-200 overflow-hidden">
                ...
                <div class="bg-indigo-700 px-10 py-10 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <h3 class="text-xl font-black text-white uppercase tracking-widest">Loan Details</h3>
                        <p class="text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em] mt-2 opacity-80 italic">Enter loan and item details below</p>
                    </div>
                </div>
                    ...
                    <form action="{{ route('loans.store') }}" method="POST">
                        ...
                        <div class="p-10 border-b border-slate-100 bg-slate-50/30">
                            <div class="flex items-center space-x-3 mb-10">
                                ...
                                <h4 class="text-sm font-black text-slate-900 uppercase tracking-widest">Customer & Date</h4>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                                ...
                                @if(request('customer_id') && ($preSelectedCustomer = $customers->find(request('customer_id'))))
                                    <div class="p-6 bg-white rounded-3xl border border-blue-200 flex items-center justify-between premium-shadow">
                                        <div class="flex items-center">
                                            <div class="w-14 h-14 bg-indigo-700 rounded-2xl flex items-center justify-center text-white mr-5 shadow-lg shadow-indigo-600/10">
                                                <span class="material-symbols-rounded text-2xl">person_check</span>
                                            </div>
                                            <div>
                                                <p class="text-[9px] text-blue-600 font-black uppercase tracking-widest leading-none mb-1.5">Selected Customer</p>
                                ...
                                @else
                                    <div class="relative group">
                                        ...
                                        <label for="customer_id" class="absolute left-6 -top-2.5 bg-white px-2 text-[10px] font-black text-blue-600 uppercase tracking-widest">
                                            Customer <span class="text-rose-600 text-xs">*</span>
                                        </label>
                                ...
                                <div class="relative group">
                                    ...
                                    <label class="absolute left-6 -top-2.5 bg-white px-2 text-[10px] font-black text-blue-600 uppercase tracking-widest">Loan Date</label>
                        ...
                        <div class="p-10 border-b border-slate-100">
                            <div class="flex items-center space-x-3 mb-10">
                                ...
                                <h4 class="text-sm font-black text-slate-900 uppercase tracking-widest">Item Rate & Value</h4>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                ...
                                <div class="relative" x-show="loanType === 'Gold' || loanType === 'Silver'">
                                    ...
                                    <label class="absolute left-6 -top-2.5 bg-white px-2 text-[10px] font-black text-blue-600 uppercase tracking-widest">Market Rate (₹/gm)</label>
                                ...
                                <div class="lg:col-span-2 grid grid-cols-2 gap-4" x-show="loanType === 'Gold' || loanType === 'Silver'">
                                    <div class="p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 flex flex-col justify-center">
                                        <p class="text-[9px] text-slate-400 font-black uppercase tracking-widest leading-none mb-2">Market Value</p>
                                    ...
                                    <div class="p-5 bg-blue-600 rounded-[1.5rem] text-white flex flex-col justify-center shadow-lg shadow-blue-600/20">
                                        <p class="text-[9px] text-blue-200 font-black uppercase tracking-widest leading-none mb-2">Loan Amount</p>
                                        <div class="flex items-baseline space-x-1">
                        ...
                        <div class="p-10 border-b border-slate-100 bg-slate-50/30">
                            <div class="flex items-center space-x-3 mb-10">
                                ...
                                <h4 class="text-sm font-black text-slate-900 uppercase tracking-widest">Loan Interest & Period</h4>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                                ...
                                <div class="relative">
                                    ...
                                    <label class="absolute left-6 -top-2.5 bg-white px-2 text-[10px] font-black text-blue-600 uppercase tracking-widest flex items-center">
                                        Loan Amount (₹)
                                        <span x-show="loanType === 'Gold' || loanType === 'Silver'" class="ml-2 text-[8px] bg-indigo-700 text-white px-2 py-0.5 rounded-full tracking-widest">80% LTV</span>
                                    </label>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-5">
                                    <div class="relative group">
                                        ...
                                        <label class="absolute left-6 -top-2.5 bg-white px-2 text-[10px] font-black text-blue-600 uppercase tracking-widest">Interest %</label>
                                    ...
                                    <div class="relative group">
                                        ...
                                        <label class="absolute left-6 -top-2.5 bg-white px-2 text-[10px] font-black text-blue-600 uppercase tracking-widest">Interest Type</label>
                                    </div>
                                </div>
                                ...
                                <div class="relative group">
                                    ...
                                    <label class="absolute left-6 -top-2.5 bg-white px-2 text-[10px] font-black text-blue-600 uppercase tracking-widest">Period (Months)</label>
                                ...
                                <div class="md:col-span-3">
                                    <textarea name="remarks" rows="2" class="w-full px-6 py-5 border border-slate-200 rounded-[1.5rem] resize-none italic text-sm text-slate-500 bg-white premium-shadow" placeholder="Notes/Remarks..."></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-10">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-12">
                                ...
                                <button type="button" @click="addItem()" class="btn-premium btn-premium-primary">
                                    <span class="material-symbols-rounded text-lg mr-2">add_box</span>
                                    <span>Add Item</span>
                                </button>
                            </div>
                                    ...
                                    <div class="p-8 border-2 border-slate-50 rounded-[2.5rem] relative bg-slate-50/50 hover:bg-white hover:border-blue-100 transition-all group premium-shadow">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                            ...
                                            <div class="relative">
                                                ...
                                                <label class="absolute left-5 -top-2.5 bg-white px-2 text-[9px] font-black text-slate-400 uppercase tracking-widest">Item Type</label>
                                            </div>
                                            ...
                                            <div class="relative" x-show="item.item_name === 'Others'">
                                                <input type="text" :name="'items['+index+'][custom_item_name]'" x-model="item.custom_name"
                                                    class="w-full px-5 py-4 border border-blue-200 rounded-[1.25rem] font-bold italic text-sm bg-white premium-shadow" placeholder="Enter Item Name...">
                                                <label class="absolute left-5 -top-2.5 bg-white px-2 text-[9px] font-black text-blue-600 uppercase tracking-widest">Item Name</label>
                                            </div>
                                            ...
                                            <div class="relative">
                                                ...
                                                <label class="absolute left-5 -top-2.5 bg-white px-2 text-[9px] font-black text-slate-400 uppercase tracking-widest">Purity Standard</label>
                                            </div>
                                            ...
                                            <div class="md:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-6 bg-white p-6 rounded-[2rem] border border-slate-100 premium-shadow">
                                                ...
                                                <div class="relative">
                                                    ...
                                                    <label class="absolute left-3 -top-2.5 bg-white px-1 text-[8px] font-black text-slate-400 uppercase tracking-widest italic">MG</label>
                                                </div>
                                                <div class="flex items-center justify-end px-4 border-l border-slate-100">
                                                    <div class="text-right">
                                                        <p class="text-[9px] font-black text-slate-300 uppercase leading-none mb-1">Total Weight</p>
                                            ...
                                            <div class="md:col-span-3">
                                                <input type="text" :name="'items['+index+'][description]'" x-model="item.description" required
                                                    class="w-full px-6 py-4 border border-slate-100 rounded-[1.25rem] bg-slate-50 text-xs font-bold text-slate-600 placeholder:text-slate-300 italic" placeholder="Item details, stones, weight, etc...">
                                            </div>
                                        </div>
                                    </div>
                                </template>
                        ...
                        <div class="p-10 bg-slate-50/80 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-6">
                            <a href="{{ route('loans.index') }}" class="btn-premium btn-premium-secondary">
                            ...
                            <button type="submit" class="btn-premium btn-premium-primary px-16">
                                <span class="material-symbols-rounded text-xl mr-2">token</span>
                                <span>Save Loan</span>
                            </button>
                        </div>
                    </form>
    ...
    <script>
        function loanForm() {
            return {
                ...
                getCommonItemNames() {
                    if (this.loanType === 'Gold') return ['Chain', 'Ring', 'Earrings', 'Necklace', 'Bangles', 'Anklets', 'Coin'];
                    if (this.loanType === 'Silver') return ['Golusu', 'Silver Ring', 'Chain', 'Ritual Vessel', 'Pooja Equipment'];
